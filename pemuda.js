...
try {
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                ...
                case 1: jamss = "Selamat Tengah Malam"; break;
                case 2: jamss = "Selamat Tengah Malam"; break;
                case 3: jamss = "Selamat Tengah Malam"; break;
                case 4: jamss = "Selamat Tengah Malam"; break;
                ...
                case 17: jamss = "Selamat Senja"; break;
                case 18: jamss = "Maghrib"; break;
                case 19: jamss = "Isha"; break;
                case 20: jamss = "Selamat Malam"; break;
                case 21: jamss = "Selamat Malam"; break;
                case 22: jamss = "Selamat Tengah Malam"; break;
                case 23: jamss = "Selamat Tengah Malam"; break;
            }
...
╰┬─━━━━═══════━━━━─⊱
 ...
 ╰─━━━━═══════━━━━─⊱
⊰─━─⊱⟮ *NOTE* ⟯⊰─━─⊱
⦿ Jika Button Tidak Muncul Sihlakan Ketik ${prefix}allmenu`
sendButLocation(from, `${menu}`, `${uwu} ⌕ ❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙❘ ⌕ ${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}allmenu`,buttonText:{displayText:'📒 MENU ALL 📒'},type:1},{buttonId:`${prefix}command`,buttonText:{displayText:'📝 COMMAND 📝'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'🧑🏽‍ DAVELOPER 💻'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'allmenu':
case 'almenu':
        ptod = "62882903894211@s.whatsapp.net"
...
└─────────────────⬣
`
pemuda.sendMessage(from, menu, text, { quoted: ftrol, thumbnail: fs.readFileSync('./pemuda_1.jpg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"",mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/dQw4w9WgXcQ`}}})
break
case 'command':
 listMsg = {
 buttonText: 'LIST MENU',
 footerText: '*_© FᴀᴛᴋᴜʟRᴀʜᴍᴀɴ_*',
...
break
		...
		case 'sc':
		case 'sourcecode':
		pemuda.sendMessage(from, { text: "Script Ini Dalam Tahap Perkembangan/Beta,Belum Bisa Di Public", matchedText: 'https://youtu.be/dQw4w9WgXcQ', description: "", title: "don't click here !!!", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
       case 'debug':
...
Giliran = @${tty.er1.split('@')[0]}`
 pemuda.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.er1,tty.er2]}})
     ...
     pemuda.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Bitch Boot",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./pemuda_1.jpg'),sourceUrl:"https://youtu.be/dQw4w9WgXcQ"}}})
	}
    }
    }
    }
